...
public class TrimmedStringsContainerEntityValidatorTest {
    ...
    public void setUp() throws Exception {
        ...
        TrimmedStringsContainerEntityValidator validator = new TrimmedStringsContainerEntityValidator(cache);
        storage = new ContainerValidatorStorage(Collections.singletonList(validator));
    }

    @Test
    public void validateCreate() {
        EntityValidator<TestEntity> v = storage.get(ContainerEntityValidator.TRIMMED_STRINGS);

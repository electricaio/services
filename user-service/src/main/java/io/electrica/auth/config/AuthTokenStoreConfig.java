package io.electrica.auth.config;

import io.electrica.auth.server.SpecialUserDetails;
...
public class AuthTokenStoreConfig {
    ...
    @Value("${spring.auth.keystore.path}")
    private String keystorePath;

    @Value("${spring.auth.keystore.secret}")
    private String certificateSecret;

    @Value("${spring.auth.keystore.key-alias}")
